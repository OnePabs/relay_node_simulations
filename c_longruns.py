...
t = 30   # 3,15,30
results_folder = r'C:\Users\juanp\OneDrive\Documents\projects\relay_node_simulations\simulation_results\longruns\c' + os.sep + str(t*100)
...
for runtime in runtimes:
    print(flush=True)
    print("now performing experiment for: " + str(runtime/min_to_millis) + " minutes", flush=True)
    ...
    for rep in range(num_repetitions):
        ...
        exp_result = simulator.run(n, t, arrivals_distribution, service_time_distribution)
