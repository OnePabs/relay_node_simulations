...
p = 1500 #150, 750, 1500 milliseconds
results_folder = r'C:\Users\juanp\OneDrive\Documents\projects\relay_node_simulations\simulation_results\longruns\b' + os.sep + str(p)
...
for runtime in runtimes:
    ...
    for rep in range(num_repetitions):
        ...
        exp_result = simulator.run(n, p, arrivals_distribution, service_time_distribution)
