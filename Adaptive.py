...
class Adaptive:
    ...
    # t = when using technique C, after t requests have been buffered, a data transfer takes place
    ...
    # use_linear_service_time = if true then the service time at the server is taken to be linear dependent on the number of requests per batch and the mean access time for a batch
    # mean_access_time: The mean time it takes for the server before it starts writing data. This is used to simulates the access time to a real storage device
